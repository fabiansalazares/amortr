...
#' @examples
#' fixed_bullet(amount=10000, interest_rate=0.01, start_date=as.Date("2020-03-19"), end_date=as.Date("2032-03-19"), frequency=4, optional_parameters=c("loan_id"="123"), truncate_month_day=FALSE)
#' fixed_bullet(amount=3000, interest_rate=0.01, start_date=as.Date("2020-03-19"), n_payments=36, frequency=12, truncate_month_day=TRUE)
#' @return a dataframe containing the amortization schedule for the loan described in the arguments

fixed_bullet <- function(
